...
from .views import gestion_horas_procesos, actualizar_horas_procesos, sync_to_server_view, eliminar_proceso,actualizar_horas_procesos,eliminar_proceso,exportar_excel
...
urlpatterns = [
    ...
    path('exportar_a_excel/', exportar_excel, name='exportar_excel'),
